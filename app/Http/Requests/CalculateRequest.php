 ...
 *     @OA\Property(property="activeFrom", type="date", example="2021-05-21", description="Дата начала действия договора Ипотеки"),
 *     @OA\Property(property="activeTo", type="date", example="2022-05-20", description="Дата окончания действия договора Ипотеки"),
