...
//
            ...
            'objects.property.buildYear' => ['required_if:objects.property', 'numeric'],
            'objects.property.isWooden' => ['boolean'],
            'objects.property.area' => ['required_if:objects.property', 'numeric'],
            ...
            'objects.life.gender' => ['required_if:objects.life', 'boolean'],
            ...
            'objects.*.city' => ['required_if:objects.*.city', 'string'],
            'objects.*.street' => ['required_if:objects.*.street', 'string'],
            'objects.*.house' => ['required_if:objects.*.house', 'string'],
            'objects.*.state' => ['required_if:objects.*.state', 'string'],
//            // Subject rules
            'subject.firstName' => ['required_if:subject', 'string'],
            'subject.lastName' => ['required_if:subject', 'string'],
            'subject.middleName' => ['string','nullable'],
            'subject.birthDate' => ['required_if:subject', 'string', 'date', 'after:' . date('Y-m-d', strtotime('-99 years')), 'before:' . date('Y-m-d', strtotime('-18 years'))],
            'subject.gender' => ['required_if:subject', 'boolean'],
            'subject.phone' => ['required_if:subject', 'string','regex:/^\+7(?:[0-9\-]){11,11}[0-9]$/m'],
            'subject.email' => ['required_if:subject', 'string','max:255','email'],
            'subject.docSeries' => ['required_if:subject','integer','min:1000','max:9999'],
            'subject.docNumber' => ['required_if:subject','integer','min:100000','max:999999'],
            'subject.docIssueDate' => ['required_if:subject', 'string', 'date', 'before:today'],
            'subject.docIssuePlace' => ['required_if:subject','string'],
            'subject.state' => ['required_if:subject','string'],
            'subject.city' => ['required_if:subject','string'],
            'subject.street' => ['required_if:subject','string'],
            'subject.house' => ['required_if:subject','string'],
            'subject.kladr' => ['required_if:subject','digits:13'],
        ];
    }
}
